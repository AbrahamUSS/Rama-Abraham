// Mock Database Wrapper using LocalStorage for IEP Corazón de Jesús College
(function() {
  ...
  const initialData = {
    students: [
      ...
      { id: 'AL004', name: 'Delgado Ruiz, Luana', nivel: 'Primaria', grado: '5to Primaria', grades: { matematica: 08, comunicacion: 13, ciencia: 09 }, attendance: { '2026-06-25': 'T', '2026-06-24': 'F', '2026-06-23': 'P' } },
    ...
    economics: {
      metrics: {
        pagoDocentes: 12000,
        morosidadPadres: 18, // 18% morosity
        gastosEpoca: 2500, // maintenance / season activities
        recaudacion: 28500,
        internet: 320,
        agua: 250,
        luz: 450,
